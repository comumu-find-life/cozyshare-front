...
class GetterInputMessageWidget extends StatefulWidget {
  ...
  GetterInputMessageWidget(this._controller);

  @override
  State<GetterInputMessageWidget> createState() => _InputMessageGetterWidget();
}

class _InputMessageGetterWidget extends State<GetterInputMessageWidget> {
  @override
