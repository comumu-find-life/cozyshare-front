...
class AddressEditValidateView extends StatefulWidget {
  final CustomLatLng? location;
  final HomeAddressEditController _controller;

  AddressEditValidateView(this.location, this._controller);

  @override
  State<AddressEditValidateView> createState() => _RoomLocationViewState();
}

class _RoomLocationViewState extends State<AddressEditValidateView> {
